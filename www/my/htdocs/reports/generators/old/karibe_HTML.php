...
<?php
	...
	foreach ($_REQUEST['cars'] as $car=>$value) {
		...
		if($CarData['tank1']||$CarData['tank2']){
			...
			for($i=0;$i<count($req);$i++){
				...
				if($i==0){
					...
					if($CarData['gosnum'])echo "<td align='center'>".$CarData['gosnum']."</td>";
					else echo "<td>&nbsp;</td>";
					echo	"<td align='center'>".date('Y-m-d',strtotime($tstimefrom))."</td>";
		...
		if($i>0){
			...
			echo	"<td align='center'>".$report->ConvertTimeToString($itogo_time_move)."</td>";
			echo	"<td align='center'>".$report->ConvertTimeToString($itogo_time_moto)."</td>";
			echo	"<td align='center'>".$report->ConvertTimeToString($itogo_time_stop)."</td>";
			echo	"<td align='center'>".($itogo_dest/1000)."</td>";
			echo	"<td align='center'>".round($itogo_fuel_start,2)."</td>";
			echo	"<td align='center'>".$itogo_count_up."</td>";
			echo	"<td align='center'>".round($itogo_up,2)."</td>";
			echo	"<td align='center'>".$itogo_count_down."</td>";
			echo	"<td align='center'>".round($itogo_down*-1,2)."</td>";
			echo	"<td align='center'>".round($itogo_fuel_end,2)."</td>";
			echo	"<td align='center'>".round($fact,2)."</td>";
			echo	"<td align='center'>".round(($fact*100000/$itogo_dest),2)."</td>";
		}
	$num++;
	}
