...
$(function(){
				    ...
				    $('#diveditcars').dialog('option','height',250);
...
function menu_editcars_save (){
 ...
 $('#iconload_editcars').load('menu/editcars_jq.php',{carid:carid_for_edit,name:fcar,fiodriver1:ffiodriver1,teldriver1:fteldriver1},function(){
