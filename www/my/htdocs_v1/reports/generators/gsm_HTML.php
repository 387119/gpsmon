...
<body style="font: 9pt Tahoma">
    <?
        ...
        foreach ($_REQUEST['cars'] as $car => $value) {
            ...
            $query = "SELECT date_part('epoch', tstamp) epoch, gsmsignal, lat/600000::real as lat, lon/600000::real as lon FROM data.gps WHERE carid=$car AND tstamp>='$datefrom $timefrom' AND tstamp<='$dateto $timeto' and lat>0 and lon>0 ORDER BY epoch";
