...
var pathToImages = 'images/theme/';	// Relative to your HTML file
...
switch(languageCode){
    case "ru":	/* English */
		...
		var monthArrayShort = ['Янв','Фев','Мар','Апр','Май','Июнь','Июль','Авг','Сен','Окт','Нбр','Дек'];
		var dayArray = ['Пон','Вт','Ср','Чт','Пт','Суб','Вос'];
...
{
	if(this.src.indexOf('over')>=0){
		this.src = pathToImages + 'x.png';
	}else{
		this.src = pathToImages + 'xh.png';
	}
